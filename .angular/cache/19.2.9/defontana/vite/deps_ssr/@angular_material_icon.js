...
import "./chunk-HSIBIOGX.js";
import "./chunk-ABQ4QERA.js";
import {
  DomSanitizer
} from "./chunk-PVPRUWAM.js";
import {
  HttpClient
} from "./chunk-EJFYN5ZZ.js";
import "./chunk-6CPBTV3U.js";
import {
  DOCUMENT
...
var MatIcon = class _MatIcon {
  ...
  _currentIconFetch = import_rxjs2.Subscription.EMPTY;
  constructor() {
  ...
  _updateSvgIcon(rawName) {
    ...
    if (rawName) {
      ...
      this._currentIconFetch = this._iconRegistry.getNamedSvgIcon(iconName, namespace).pipe((0, import_operators2.take)(1)).subscribe((svg) => this._setSvgElement(svg), (err) => {
