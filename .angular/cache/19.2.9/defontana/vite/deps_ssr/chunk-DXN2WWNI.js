...
} from "./chunk-ZPTJZGQW.js";
import {
  ErrorStateMatcher,
  _ErrorStateTracker
} from "./chunk-ONOONCKK.js";
import {
  FormGroupDirective,
  NgControl,
  NgForm,
  Validators
} from "./chunk-43NQHKMY.js";
import {
  MAT_FORM_FIELD,
  MatFormFieldControl,
  MatFormFieldModule
} from "./chunk-KATFTZVW.js";
import {
  _isTestEnvironment
} from "./chunk-O6CIOFW5.js";
import {
  SelectionModel
} from "./chunk-NAUCWGY2.js";
import {
  coerceCssPixelValue
...
} from "./chunk-GWZIOKID.js";
import {
  _CdkPrivateStyleLoader,
  _bindEventWithOptions
} from "./chunk-M56OD7KX.js";
import {
  Platform
} from "./chunk-HSIBIOGX.js";
import {
  BidiModule,
  Directionality
} from "./chunk-ABQ4QERA.js";
import {
  Location,
  NgClass
} from "./chunk-6CPBTV3U.js";
import {
  DOCUMENT
} from "./chunk-JAXOFING.js";
import {
...
var MatOption = class _MatOption {
  ...
  _stateChanges = new import_rxjs3.Subject();
  constructor() {
...
var MatSelect = class _MatSelect {
  ...
  optionSelectionChanges = (0, import_rxjs4.defer)(() => {
    ...
    if (options) {
      return options.changes.pipe((0, import_operators3.startWith)(options), (0, import_operators3.switchMap)(() => (0, import_rxjs4.merge)(...options.map((option) => option.onSelectionChange))));
    }
    return this._initialized.pipe((0, import_operators3.switchMap)(() => this.optionSelectionChanges));
  });
  /** Event emitted when the select panel has been toggled. */
  openedChange = new EventEmitter();
  /** Event emitted when the select has been opened. */
  _openedStream = this.openedChange.pipe((0, import_operators3.filter)((o) => o), (0, import_operators3.map)(() => {
  }));
  /** Event emitted when the select has been closed. */
  _closedStream = this.openedChange.pipe((0, import_operators3.filter)((o) => !o), (0, import_operators3.map)(() => {
  }));
  ...
  ngOnInit() {
    ...
    this.stateChanges.next();
    this._viewportRuler.change().pipe((0, import_operators3.takeUntil)(this._destroy)).subscribe(() => {
      if (this.panelOpen) {
  ...
  ngAfterContentInit() {
    ...
    this._selectionModel.changed.pipe((0, import_operators3.takeUntil)(this._destroy)).subscribe((event) => {
      event.added.forEach((option) => option.select());
      event.removed.forEach((option) => option.deselect());
    });
    this.options.changes.pipe((0, import_operators3.startWith)(null), (0, import_operators3.takeUntil)(this._destroy)).subscribe(() => {
      this._resetOptions();
      this._initializeSelection();
    });
  }
  ...
  open() {
    ...
    this._overlayDir.positionChange.pipe((0, import_operators3.take)(1)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
  ...
  _resetOptions() {
    ...
    this.optionSelectionChanges.pipe((0, import_operators3.takeUntil)(changedOrDestroyed)).subscribe((event) => {
    ...
    (0, import_rxjs4.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators3.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
...
//# sourceMappingURL=chunk-DXN2WWNI.js.map
